-- Security hardening for tenant membership, client administration, and helper RPCs.
-- Existing internal client data is preserved in client_internal_metadata before
-- the legacy columns are removed from the tenant-visible clients table.
